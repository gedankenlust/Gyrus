...
[![Version](https://img.shields.io/badge/version-0.5.0-orange.svg?style=flat-square)](#project-status)
...
Gyrus is in active development (**v0.5.0**). It is stable for daily use and
